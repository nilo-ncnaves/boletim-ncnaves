...
| 3 | Visão Geral — todas as fazendas num lugar só (porta chamada "Diretoria" até a v100; v101, item c23) | Entrada | D, A | G, P | **continuar oculta** | O painel mostra todas as fazendas: fora do domínio do gerente (condição 3). Ele já sabe que existe Diretoria; o botão cinza não o ajuda a pedir nada. |
...
| 5 | Cadastros — fazendas, talhões e insumos (porta chamada "Escritório / Administrador" até a v100; v101, item c23) | Entrada | A | G, P, D | **continuar oculta** | Ação administrativa. Na tela de entrada da Diretoria, ver #7. |
...
| 15 | Novo prazo (chips +7 · +15 · fim do mês · próxima reunião) — **v91** | Ação rápida "⋯" das listas de Planejamento e folha da tarefa | D, A | G | **continuar oculta** | Repactuar prazo é decisão do escritório; para o gerente é ação administrativa (nunca esmaecida, regra fixa). Sem mudança de quem pode o quê: até a v90 a folha decidia com `if(papel)`; agora é `ACOES_PERFIL.tarefa_prazo`. |
| 16 | Definir meta / Meta · N ha — **v91** | Ação rápida "⋯" das listas de Planejamento e folha da tarefa | D, A | G | **continuar oculta** | A meta em ha é da ata/escritório (v78); o gerente nunca digita meta (regra 2 do plano de safra). `ACOES_PERFIL.tarefa_meta`. |
