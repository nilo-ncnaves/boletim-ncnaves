...
-- >>> seed gerado por scripts/gerar_catalogo_operacoes.cjs (75 operações, 90 apelidos)
insert into public.operacao_catalogo (id, atividade, fase, nome, ordem) values
  ('CAFE-COLHEITA', 'CAFE', null, 'Colheita', 1),
  ('CAFE-CATACAO', 'CAFE', null, 'Catação', 2),
  ('CAFE-REPASSE', 'CAFE', null, 'Repasse', 3),
  ('CAFE-PULVERIZACAO', 'CAFE', null, 'Pulverização', 4),
  ('CAFE-APLICACAO_DE_HERBICIDA', 'CAFE', null, 'Aplicação de herbicida', 5),
  ('CAFE-ADUBACAO_VIA_LANCO', 'CAFE', null, 'Adubação via lanço', 6),
  ('CAFE-ADUBACAO_ORGANICA', 'CAFE', null, 'Adubação orgânica', 7),
  ('CAFE-APLICACAO_VIA_DRENCH_VIA_SOLO', 'CAFE', null, 'Aplicação via drench / via solo', 8),
  ('CAFE-CALAGEM_GESSAGEM', 'CAFE', null, 'Calagem / gessagem', 9),
  ('CAFE-CAPINA_MANUAL', 'CAFE', null, 'Capina manual', 10),
  ('CAFE-CAPINA_ROCADEIRA_TRINCHA', 'CAFE', null, 'Capina roçadeira / trincha', 11),
  ('CAFE-ARRUACAO_ESPARRAMACAO_DE_CISCO', 'CAFE', null, 'Arruação / esparramação de cisco', 12),
  ('CAFE-DESBROTA', 'CAFE', null, 'Desbrota', 13),
  ('CAFE-PODA_ESQUELETAMENTO', 'CAFE', null, 'Poda / esqueletamento', 14),
  ('CAFE-MONITORAMENTO_DE_PRAGAS', 'CAFE', null, 'Monitoramento de pragas (MIP)', 15),
  ('CAFE-LIMPEZA_DO_SISTEMA_DE_IRRIGACAO', 'CAFE', null, 'Limpeza do sistema de irrigação', 16),
  ('CAFE-IRRIGACAO', 'CAFE', null, 'Irrigação', 17),
  ('CAFE-PLANTIO_RENOVACAO', 'CAFE', null, 'Plantio / renovação', 18),
  ('CAFE-MANUTENCAO_DE_ESTRADAS_E_ACEIROS', 'CAFE', null, 'Manutenção de estradas e aceiros', 19),
...
insert into public.operacao_alias (operacao_id, origem, termo) values
  ...
  ('CAFE-PULVERIZACAO', 'atividades.tipo', 'Pulverização'),
  ('CAFE-APLICACAO_DE_HERBICIDA', 'atividades.tipo', 'Aplicação de herbicida'),
  ...
  ('CAFE-CAPINA_ROCADEIRA_TRINCHA', 'atividades.tipo', 'Capina roçadeira / trincha'),
  ('CAFE-ARRUACAO_ESPARRAMACAO_DE_CISCO', 'atividades.tipo', 'Arruação / esparramação de cisco'),
  ('CAFE-DESBROTA', 'atividades.tipo', 'Desbrota'),
  ('CAFE-PODA_ESQUELETAMENTO', 'atividades.tipo', 'Poda / esqueletamento'),
  ...
  ('CAFE-IRRIGACAO', 'atividades.tipo', 'Irrigação'),
