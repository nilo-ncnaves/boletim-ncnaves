...
-- AVISO: fazenda 'Vereda Café' NÃO confirmada (app candidato: f22c 'Vereda — Café') — seed grava o nome do plano; sem alias app; o app não carrega este plano
-- AVISO: fazenda 'Lagamar Café – Rodrigo' NÃO confirmada (app candidato: f20 'Lagamar Café (Rodrigo)') — seed grava o nome do plano; sem alias app; o app não carrega este plano
-- AVISO: fazenda 'Mata Preta - Café' NÃO confirmada (app candidato: f13c 'Mata Preta — Café') — seed grava o nome do plano; sem alias app; o app não carrega este plano
...
-- ====================================================================
-- AJUSTE PENDENTE — só depois que o Nilo confirmar o nome da fazenda
-- (regra 5: nomes não idênticos ao cadastro do app não são mapeados).
-- Passos: 1) trocar confirmado para true em docs/plano/2026-27/depara_fazendas.json;
--         2) rodar de novo scripts/gerar_seed_plano.py e o seed gerado (cria os aliases app);
--         3) se a carga acima JÁ foi feita, rodar também os updates abaixo (descomentar).
-- ====================================================================
